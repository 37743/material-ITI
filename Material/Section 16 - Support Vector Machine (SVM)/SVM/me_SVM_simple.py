# -*- coding: utf-8 -*-
#"""Created on Fri Oct  5 07:19:54 2018 @author: Nour """

#SVM (support vector machine )
#it can be linear or non-linear classifier by selecting its type from kernal para.
#in SCM lib.
#it classifies by draw line (max. margin hyperplane) between two vectors( last points 
#in different sets)
