# -*- coding: utf-8 -*-
#"""Created on Fri Oct  5 11:03:01 2018  @author: Nour"""

#kernal SVM ( kernal support vector machine )
#it is non-linear classifier by selecting its type from kernal para. in scm lib.
#it has many types like 'poly', 'rbf'(gussian), 'sigmoid'
...
#result 
# 'rbf'(gussian kernal)        No.of false predictions=3+4=7
...
classifier=SVC(kernel='rbf', random_state=0)   #rbf :using gussian kernal
